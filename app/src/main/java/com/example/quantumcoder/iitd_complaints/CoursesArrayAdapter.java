...
public class CoursesArrayAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(com.example.quantumcoder.iitd_complaints.R.layout.courselist_layout, parent, false);
        //TextView textView = (TextView) rowView.findViewById(R.id.no);
        TextView textView2 = (TextView) rowView.findViewById(com.example.quantumcoder.iitd_complaints.R.id.courseName);
