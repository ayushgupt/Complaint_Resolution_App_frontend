 ...
 */
public class FragmentAdminUnresolved extends android.support.v4.app.Fragment{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        admin_unresolved_ArrayAdapter dataAdapter = new admin_unresolved_ArrayAdapter(getContext(), head ,time  );
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.admin_unresolved,null);
    }
}
