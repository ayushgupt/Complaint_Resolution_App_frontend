 ...
 */
public class FragmentAdminresolved extends android.support.v4.app.Fragment{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        admin_resolved_ArrayAdapter dataAdapter = new admin_resolved_ArrayAdapter(getContext(), head ,time  );
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.admin_resolved,null);
    }
}
