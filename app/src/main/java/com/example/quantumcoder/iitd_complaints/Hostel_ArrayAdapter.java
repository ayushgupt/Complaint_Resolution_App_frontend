 ...
 */
public class Hostel_ArrayAdapter extends ArrayAdapter<String>{
    ...
    public Hostel_ArrayAdapter(Context context, String[] head, String[] owner,String[] time,String[] upvote) {
