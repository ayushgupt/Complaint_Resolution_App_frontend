 ...
 */
public class Institute_ArrayAdapter extends ArrayAdapter<String>{
    ...
    public Institute_ArrayAdapter(Context context, String[] head, String[] owner,String[] time,String[] upvote) {
