 ...
 */
public class My_unresolved_ArrayAdapter extends ArrayAdapter<String>{
    ...
    public My_unresolved_ArrayAdapter(Context context, String[] head,String[] time,String[] upvote,String[] type) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(type[position].equals("Individual"))
        {
            ...
            View rowView = inflater.inflate(R.layout.ind_unresolved_row, parent, false);
