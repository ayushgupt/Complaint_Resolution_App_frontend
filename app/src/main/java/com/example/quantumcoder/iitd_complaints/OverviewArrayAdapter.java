...
public class OverviewArrayAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(com.example.quantumcoder.iitd_complaints.R.layout.overview_list, parent, false);
        //TextView textView = (TextView) rowView.findViewById(R.id.no);
        TextView textView1 = (TextView) rowView.findViewById(com.example.quantumcoder.iitd_complaints.R.id.week);
        TextView textView2 = (TextView) rowView.findViewById(com.example.quantumcoder.iitd_complaints.R.id.timeline);
