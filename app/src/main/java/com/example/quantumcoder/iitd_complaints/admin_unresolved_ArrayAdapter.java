 ...
 */
public class admin_unresolved_ArrayAdapter extends ArrayAdapter<String>{
    private final Context context;
    private final String[] head;
    private final String[] time;


    public admin_unresolved_ArrayAdapter(Context context, String[] head,String[] time) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.admin_unresolved_row, parent, false);
