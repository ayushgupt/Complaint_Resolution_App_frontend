 ...
 */
public class ind_ArrayAdapter extends ArrayAdapter<String>{
    private final Context context;
    private final String[] head;
    private final String[] time;


    public ind_ArrayAdapter(Context context, String[] head,String[] time) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.ind_row, parent, false);
